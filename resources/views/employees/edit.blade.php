                ...
                <form action="{{ route('employees.update', $employee->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" class="form-control" @error('address') is-invalid
                            @enderror>{{ old('address', $employee->address) }}</textarea>
                        @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select name="department_id" class="form-control" @error('department_id') is-invalid @enderror>
                            ...
                            <option value="{{ $department->id }}" @if(old('department_id',$employee->department_id) ==
                                $department->id)
                                selected
                    ...
                    <div class="mb-3">
                        ...
                        <select name="role_id" class="form-control" @error('role_id') is-invalid @enderror>
                            ...
                            <option value="{{ $role->id }}" @if(old('role_id',$employee->role_id) ==
                                $role->id )
                                selected
